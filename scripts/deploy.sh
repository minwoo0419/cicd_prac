#!/bin/bash
BUILD_PATH=$(ls /home/ubuntu/app/cicd-prac-0.0.1-SNAPSHOT.jar)
...
GREEN_APPLICATION=$GREEN_PROFILE-cicd-prac-0.0.1-SNAPSHOT.jar
...
BLUE_PID=$(pgrep -f $BLUE_PROFILE-cicd-prac-0.0.1-SNAPSHOT.jar)
